...
export const EXERCISES: Exercise[] = [
  ...
  { id: 'ex-25', name: 'Front Squat', muscleGroup: MuscleGroup.Legs, equipment: 'Barbell', tags: ['squat', 'quads', 'front squat', 'barbell', 'compound'] },
  { id: 'ex-26', name: 'Goblet Squat', muscleGroup: MuscleGroup.Legs, equipment: 'Dumbbell', tags: ['squat', 'quads', 'goblet', 'dumbbell', 'compound'] },
  { id: 'ex-27', name: 'Walking Lunge', muscleGroup: MuscleGroup.Legs, equipment: 'Dumbbell', tags: ['lunge', 'quads', 'glutes', 'dumbbell', 'unilateral'] },
  { id: 'ex-28', name: 'Hack Squat', muscleGroup: MuscleGroup.Legs, equipment: 'Machine', tags: ['squat', 'quads', 'hack squat', 'machine', 'compound'] },
  { id: 'ex-29', name: 'Standing Calf Raise', muscleGroup: MuscleGroup.Legs, equipment: 'Machine', tags: ['calf raise', 'calves', 'machine', 'isolation'] },
  { id: 'ex-30', name: 'Seated Calf Raise', muscleGroup: MuscleGroup.Legs, equipment: 'Machine', tags: ['calf raise', 'calves', 'seated', 'machine', 'isolation'] },
  { id: 'ex-31', name: 'Sumo Deadlift', muscleGroup: MuscleGroup.Legs, equipment: 'Barbell', tags: ['deadlift', 'sumo', 'glutes', 'inner thigh', 'barbell', 'compound'] },
  { id: 'ex-32', name: 'Dumbbell Romanian Deadlift', muscleGroup: MuscleGroup.Legs, equipment: 'Dumbbell', tags: ['rdl', 'hamstrings', 'glutes', 'dumbbell'] },
  { id: 'ex-33', name: 'Step Up', muscleGroup: MuscleGroup.Legs, equipment: 'Dumbbell', tags: ['step up', 'quads', 'glutes', 'unilateral', 'dumbbell'] },
  { id: 'ex-34', name: 'Glute Kickback', muscleGroup: MuscleGroup.Legs, equipment: 'Cable', tags: ['kickback', 'glutes', 'cable', 'isolation'] },
  { id: 'ex-35', name: 'Sissy Squat', muscleGroup: MuscleGroup.Legs, equipment: 'Bodyweight', tags: ['squat', 'quads', 'bodyweight', 'isolation'] },
  { id: 'ex-36', name: 'Pendulum Squat', muscleGroup: MuscleGroup.Legs, equipment: 'Machine', tags: ['squat', 'quads', 'machine', 'compound'] },
  { id: 'ex-37', name: 'Nordic Hamstring Curl', muscleGroup: MuscleGroup.Legs, equipment: 'Bodyweight', tags: ['hamstrings', 'nordic', 'bodyweight', 'eccentric'] },
  ...
  { id: 'ex-86', name: 'Barbell Curl', muscleGroup: MuscleGroup.Arms, equipment: 'Barbell', tags: ['curl', 'biceps', 'barbell', 'compound'] },
  { id: 'ex-87', name: 'Preacher Curl', muscleGroup: MuscleGroup.Arms, equipment: 'Dumbbell', tags: ['preacher', 'curl', 'biceps', 'dumbbell', 'isolation'] },
  { id: 'ex-88', name: 'Cable Curl', muscleGroup: MuscleGroup.Arms, equipment: 'Cable', tags: ['curl', 'biceps', 'cable', 'isolation'] },
  { id: 'ex-89', name: 'Incline Dumbbell Curl', muscleGroup: MuscleGroup.Arms, equipment: 'Dumbbell', tags: ['incline', 'curl', 'biceps', 'dumbbell', 'stretch'] },
  { id: 'ex-90', name: 'Concentration Curl', muscleGroup: MuscleGroup.Arms, equipment: 'Dumbbell', tags: ['concentration', 'curl', 'biceps', 'dumbbell', 'isolation'] },
  { id: 'ex-91', name: 'EZ-Bar Curl', muscleGroup: MuscleGroup.Arms, equipment: 'Barbell', tags: ['ez bar', 'curl', 'biceps', 'barbell'] },
  { id: 'ex-92', name: 'Overhead Tricep Extension', muscleGroup: MuscleGroup.Arms, equipment: 'Dumbbell', tags: ['triceps', 'overhead', 'extension', 'dumbbell'] },
  { id: 'ex-93', name: 'Cable Overhead Extension', muscleGroup: MuscleGroup.Arms, equipment: 'Cable', tags: ['triceps', 'overhead', 'extension', 'cable'] },
  { id: 'ex-94', name: 'Tricep Kickback', muscleGroup: MuscleGroup.Arms, equipment: 'Dumbbell', tags: ['triceps', 'kickback', 'dumbbell', 'isolation'] },
  { id: 'ex-95', name: 'Close-Grip Push Up', muscleGroup: MuscleGroup.Arms, equipment: 'Bodyweight', tags: ['triceps', 'push up', 'bodyweight', 'compound'] },
  { id: 'ex-96', name: 'Reverse Curl', muscleGroup: MuscleGroup.Arms, equipment: 'Barbell', tags: ['reverse curl', 'forearms', 'brachioradialis', 'barbell'] },
  { id: 'ex-97', name: 'Wrist Curl', muscleGroup: MuscleGroup.Arms, equipment: 'Barbell', tags: ['wrist curl', 'forearms', 'barbell', 'isolation'] },
  { id: 'ex-98', name: 'Machine Preacher Curl', muscleGroup: MuscleGroup.Arms, equipment: 'Machine', tags: ['preacher', 'curl', 'biceps', 'machine'] },
  { id: 'ex-99', name: 'Dip Machine', muscleGroup: MuscleGroup.Arms, equipment: 'Machine', tags: ['dips', 'triceps', 'machine', 'compound'] },
  { id: 'ex-100', name: 'Spider Curl', muscleGroup: MuscleGroup.Arms, equipment: 'Dumbbell', tags: ['spider', 'curl', 'biceps', 'dumbbell', 'isolation'] },
  { id: 'ex-101', name: 'JM Press', muscleGroup: MuscleGroup.Arms, equipment: 'Barbell', tags: ['jm press', 'triceps', 'barbell', 'compound'] },
